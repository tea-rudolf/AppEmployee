    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">Assign task</h2>
          <div>
			<form:form role="form" method="POST" action="/tasks/add" modelAttribute="task">
				...
				<div class="form-group">
					...
					<form:input class="form-control" path="employee" value="${employee}" />
				</div>
				<div class="form-group">
					<input type="submit" value="Assign task" class="btn btn-primary"></input>
				</div>
			</form:form>
          </div>
        </div>
