...
public class ExpenseService {
	...
	public void createExpense(ExpenseViewModel viewModel) throws Exception {
		expenseProcessor.createExpense(viewModel.getAmount(), new LocalDate(viewModel.getDate()),
				viewModel.getUserEmail(), viewModel.getComment());
	}

	public void editExpense(ExpenseViewModel viewModel) throws Exception {
		expenseProcessor.editExpense(viewModel.getUid(), viewModel.getAmount(), new LocalDate(viewModel.getDate()),
				viewModel.getUserEmail(), viewModel.getComment());
	}
