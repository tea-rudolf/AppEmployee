...
public class DepartmentProcessor {
	...
	public void createDepartment(String departmentName, List<String> userEmails) throws Exception {
		...
		if (departmentRepository.findByName(departmentName) != null) {
			throw new DepartmentAlreadyExistsException(String.format("The department %s already exists!",
					departmentName));
		}
	...
	public void removeEmployeesListFromUnassignedDepartment(List<String> userEmails) throws Exception {
		for (String userEmail : userEmails) {
			unassignEmployeeToDepartment(userEmail, DEPARTMENT_OF_UNASSIGNED_EMPLOYEES);
		}
	}
